          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="业务类型名称" prop="skillName" :rules="commonRule">
                <el-input v-model="form.skillName" size="small" style="width: 250px"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-col :span="24">
  ...
  export default {
    ...
    methods: {
      ...
      loadEditData() {
        ...
        API.skillType.details(obj).then(res => {
          this.form = res;
          console.log(res)
        });
      },
      onSubmit(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            API.skillType.update(this.form).then(res => {
              this.$message({
                message: '保存成功！',
                type: 'success'
              });
