<template>
  <div class="page-content">
    <div class="bs-header">
      <div class="bs-title"><span style="font-weight: bolder">用户余额交易记录</span></div>
    </div>
    <div>
      <!--      搜索查询参数表单-->
      ...
      <div class="table-wrap" v-loading.body="loading">
        ...
        <el-table  highlight-current-row
          ...
          <el-table-column  align="center"  label="操作" min-width="8%">
            <template slot-scope="scope">
              <el-button type="primary" plain size="small"  v-power="'yhye_check'"   @click="handleView(scope.$index, scope.row)">详情</el-button>
              <el-button type="danger"  plain size="small"  v-power="'yhye_delete'"  @click="handleDelete(scope.$index, scope.row)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!--分页展示-->
