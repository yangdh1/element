<template>
    <div class="TextScroll" style="background: #f9f9f9;border-bottom: 1px solid #eee;">
        ...
        created() {
            ...
            switch (this.scrollType) {
                ...
                case 'scroll-left':this.playTime = 2000
                    break;
                case 'scroll-left-linear':this.playTime = 10000
                    break;
...
<style scoped>
    ...
    .scroll-left-linear-leave-active{
        transition: all 10s linear;   /*此时间必须和 playTime 保持一致*/
    }
